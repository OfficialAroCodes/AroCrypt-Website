...
const MacDownloadModal: React.FC<MacDownloadModalProps> = ({ downloadLink, onClose, isShown }) => {
    ...
    return (
        <div className={`modal_main_container ${isShown ? 'show' : ''}`}>
            <div className='modal_box' ref={ref}>
                ...
                <div className='modal_buttons'>
                    ...
                    <a
                        ...
                        onClick={() => {
                            setTempDownloadLink(downloadLink);
                            handleClose();
                            router.push('/thanks');
                        }}
                    >
